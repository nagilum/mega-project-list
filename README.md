...
I've been a programmer of sort for most of my life, but one never gets done learning, so I'm starting this project of projects that will certainly take me within areas I've never coded before.

I will be using different languages to complete these project, mainly because I believe some languages are better served for createing certain types of applications.

If I solve a project as a web utility, then it's most likely gonna be written in PHP or C#/APSx, if it's a GUI application I will be using C#, and so on.
...
[**Reverse a String**](https://github.com/nagilum/mega-project-list/tree/master/Text/ReverseAString) (PHP) - Enter a string and the program will reverse it and print it out.
